...
INSERT INTO CURSO VALUES (106, 'Programación C++',NULL, 30, 'Noche', 6);
INSERT INTO CURSO VALUES (107, 'Programación Pascal',NULL, 35, 'Noche', 4);
INSERT INTO CURSO VALUES (108, 'Inteligencia Artificial',NULL, 35, 'Noche', 5);
...
INSERT INTO INSCRIPCION VALUES (14,102,51200, '2012-05-02 18:45:00');
  ...
  select count (profesor_id) as cantidad_profesores 
	from
	  (SELECT profesor_id, COUNT(codigo) as cantidad_cursos 
       	 from CURSO 
       	where turno = "Noche" 
