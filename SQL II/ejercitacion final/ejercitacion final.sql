...
INSERT INTO INSCRIPCION VALUES (14,102,51200, '2012-05-02 18:45:00');
  ...
  SELECT e.legajo, COUNT (i.CURSO_codigo) as 'Cantidad de cursos'
  	from ESTUDIANTE e LEFT JOIN INSCRIPCION i 
    				  ON e.legajo = i.ESTUDIANTE_legajo
    group by e.legajo;
    
  SELECT e.legajo, COUNT (i.CURSO_codigo) as Cantidad_cursos
	from ESTUDIANTE e LEFT JOIN INSCRIPCION i 
    				  ON e.legajo = i.ESTUDIANTE_legajo
group by e.legajo HAVING Cantidad_cursos > 1;
  ...
  SELECT e.*
	from ESTUDIANTE e LEFT JOIN INSCRIPCION i 
    				  ON e.legajo = i.ESTUDIANTE_legajo
group by e.legajo HAVING COUNT (i.CURSO_codigo)  = 0;
...
GROUP by e.legajo;
	...
	#TABLA CURSO
/*  	campo codigo clave primaria indice clousterizado
 	campo profesor_id clave foranea indice no clousterizado
*/
	#TABLA ESTUDIANTE
/*	campo legajo clave primaria indice clousterizado
*/
	#TABLA INSCRIPCION
/*	campo numero clave primaria indice clousterizado
	campo CURSO_codigo clave foranea indice no clousterizado
    	campo ESTUDIANTE_legajo clave foranea indice no clousterizado
*/
	#TABLA PROFESOR
/*	campo id clave primaria indice clousterizado 
*/
